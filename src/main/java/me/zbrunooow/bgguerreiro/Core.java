...
public final class Core extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if(getServer().getPluginManager().getPlugin("nChat") != null || getServer().getPluginManager().getPlugin("Legendchat") != null) {
            Bukkit.getConsoleSender().sendMessage(prefix + "§aChatAPI carregada (A tag vai funcionar) [LegendChat/nChat]");
            ...
            Bukkit.getConsoleSender().sendMessage(prefix + "§aChatAPI carregada (A tag vai funcionar) [UltimateChat]");
            ...
            Bukkit.getConsoleSender().sendMessage(prefix + "§cChatAPI não carregada (A TAG NÃO VAI FUNCIONAR)");
        }
        ...
        mysql = new MySQL(Config.get().getUser(), Config.get().getPass(), Config.get().getUrl(), Config.get().getPort(), Config.get().getDatabase());
    ...
    public CamaroteManager getCM() { return cm; }
